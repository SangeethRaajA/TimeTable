...
//                lecture_list.setToolTipText(lectureName);
    ...
    private void setSessionDetailsSubject1(String sid){
        try{
            String sql ="select * from session1 where session_id ='"+sid+"'";
            ...
            result6 = pst6.executeQuery();
                ...
                String noOfStudentData = result6.getString("number_of_student");
                String durationData = result6.getString("duration");
                tag3.setText(tagData);
                group3.setText(groupData);
                subject3.setText(subject_nameData);
                subject_code3.setText("("+subjectIDData+")");
                noOfStudent3.setText(noOfStudentData);
                duration3.setText("("+durationData+")");
    ...
    private void setSessionLectureDetailsSubject1(String sid){
        try{
            String sql ="select * from sessionLectures where sessionID ='"+sid+"'";
...
//                lecture_list.setToolTipText(lectureName);
    ...
    private void initComponents() {
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lectureName2, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel20Layout.createSequentialGroup()
                ...
                .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(group1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel7.setText("TimeTable Creater");
        ...
        searchSession_card_pnlLayout.setHorizontalGroup(
            ...
            .addGroup(searchSession_card_pnlLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(searchSession_card_pnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void session_Subject_searchValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_session_Subject_searchValueChanged
        ...
        setSessionDetailsSubject1(session_id);
        setSessionLectureDetailsSubject1(session_id);
